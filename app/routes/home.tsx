...
function ChessFigure({ sx }: { sx: SxProps }) {
  return (
    <SvgIcon sx={sx}>
      <svg
        height="800px"
      ...
      >
        <g>
          <path
            d="M100.807,213.441c-5.014,0-9.08,4.066-9.08,9.08c0,5.014,4.066,9.07,9.08,9.07c5.015,0,9.08-4.056,9.08-9.07
		C109.887,217.507,105.822,213.441,100.807,213.441z"
          />
          <path
            d="M449.433,436.201c1.488-3.446,2.367-7.492,2.357-11.907c0.01-4.295-0.738-8.311-2.107-11.887
...
function CardsIcon({ sx }: { sx?: SxProps }) {
  return (
    <SvgIcon sx={sx}>
      <svg
        width="800px"
